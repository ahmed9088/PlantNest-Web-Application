...
if (isset($_SESSION['profile'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // Your code to display user profile information can be placed here
    } else {
...
<body>
  ...
  <![endif]-->
				...
				<div class="col-lg-4 col-md-4">
					<div class="contact-info">
						...
						<div class="single-contact-info">
							...
							<p>Plant Nest. Pakistan</p>
						</div>
						<div class="single-contact-info">
							<h4><i class="fa fa-phone"></i>Phone</h4>
							<p>Mobile:03188893863</p>
							<p>Mobile:03073762276</p>
						</div>
						<div class="single-contact-info">
					...
					<div class="contact-form style-3">
						<form id="contactForm" data-toggle="validator" method="POST" action="http://careeraid.net/html/garden-preview/assets/php/contact.php">
							<div class="row">
								...
								<div class="col-lg-12">
									<textarea placeholder="Message" id="message" name="msg"></textarea>
								</div>
								<div class="col-lg-4">
									<button class="btn-common" id="form-submit" >Send message</button>
								</div>
								<div class="col-lg-8 text-left pt-30">
									<div id="msgSubmit" class="hidden" type="submit" name="submit" value="Submit"></div>
								</div>
							</div>
						</form>
					</div>
	...
	<div class="google-map-area mt-80 sm-mt-75 xs-mt-50">
		...
		e33!2sAptech%20Defence%20Hyderabad!5e0!3m2!1sen!2s!4v1691651797021!5m2!1sen!2s" 
...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        $mail->Username = 'alihassanchand32@gmail.com'; //SMTP username
        $mail->Password = 'jmkykrsvbukxqnfn'; //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS; //Enable implicit TLS encryption
        $mail->Port = 465; //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

        //Recipients
        $mail->setFrom('alihassanchand24@gmail.com', 'Contact Form');
        $mail->addAddress('alihassanchand32@gmail.com', "PlantNest"); //Add a recipient


        //Content
        $mail->isHTML(true); //Set email format to HTML
        $mail->Subject = 'Test Contact Form';
        $mail->Body = "Sender Name - $name <br> Sender Email - $email <br> subject - $mobile <br> Feedback/Complaint - $msg";
