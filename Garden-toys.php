...
if ($sort === 'price_low') {
	$query = "SELECT * FROM garden_toys ORDER BY price ASC";
} else if ($sort === 'price_high') {
	$query = "SELECT * FROM garden_toys  ORDER BY price DESC";
} else {
	$query = "SELECT * FROM garden_toys";
}

$result_garden_toys = mysqli_query($conn, $query);
$result_garden_toys_details = mysqli_query($conn, $query);
...
<body>
  ...
  <![endif]-->
							...
							<div class="search search-box">
								...
								<div class="search-container">
									<input type="search" name="search" id="search" placeholder="Search"
										onkeyup="search_data('garden_toys')">
								</div> <br>

								<div class="row" id="animes_container">
									<!-- Movie cards will be displayed here dynamically using AJAX -->
								</div>

								<!-- Common JavaScript code for the search functionality -->
								<script>
									function search_data(category) {
										var search = document.getElementById('search').value.trim();
										var regex = /[a-zA-Z0-9]/;

										if (!regex.test(search)) {
											document.getElementById('animes_container').innerHTML = '';
											return;
										}

										// Send AJAX request to the appropriate PHP file based on the category
										var url = 'getData.php'; // The PHP file handles queries for all categories (animes, animes, Dramas)
										jQuery.ajax({
											type: 'post',
											url: url,
											data: { search: search, category: category }, // Pass the category to identify which type of data to retrieve
											success: function (data) {
												document.getElementById('animes_container').innerHTML = data;
											},
	...
	<div class="page-banner-area bg-6">
		<img class="bannerback6" src="assets\images\card\garden-toy-card-1.jpg" alt="">
		<div class="container">
			<div class="row align-items-center height-400">
				<div class="col-lg-12">
					<div class="page-banner-text text-center">
						<h2><u>Garden Toys</u></h2>
				...
				<div class="col-lg-3 col-md-4">
					<div class="sidebar sm-mt-0">
						...
						<div class="single-sidebar no-bg product-list">
							...
							<ul class="list-none">
								<li>
									<a href="#"><img src="assets\images\card\garden-toy-card-1.jpg" alt="" /></a>
							...
							<div class="tab-content mt-30">
								<div id="home" class="tab-pane active">
									<div class="row" id="products-list">
										<?php while ($data = mysqli_fetch_assoc($result_garden_toys)) { ?>
								...
								<div id="menu1" class="tab-pane fade">
									<?php while ($data = mysqli_fetch_assoc($result_garden_toys_details)) { ?>
										<div class="row">
											<div class="col-sm-12">
