...
if ($sort === 'price_low') {
	$query = "SELECT * FROM soil_and_set ORDER BY price ASC";
} else if ($sort === 'price_high') {
	$query = "SELECT * FROM soil_and_set  ORDER BY price DESC";
} else {
	$query = "SELECT * FROM soil_and_set";
}

$result_soil_and_set = mysqli_query($conn, $query);
$result_soil_and_set_details = mysqli_query($conn, $query);
...
<body>
  ...
  <![endif]-->
	...
	<div class="page-banner-area bg-6">
		<img class="bannerback6" src="assets\images\card\garden-Soil&set-card-1.jpg" alt="">
		<div class="container">
			<div class="row align-items-center height-400">
				<div class="col-lg-12">
					<div class="page-banner-text text-center">
						<h2><u>Garden Soil and Set	</u></h2>
				...
				<div class="col-lg-3 col-md-4">
					<div class="sidebar sm-mt-0">
						...
						<div class="single-sidebar no-bg product-list">
							...
							<ul class="list-none">
								<li>
									<a href="#"><img src="assets\images\card\garden-Soil&set-card-2.jpg" alt="" /></a>
							...
							<div class="tab-content mt-30">
								<div id="home" class="tab-pane active">
									<div class="row" id="products-list">
										<?php while ($data = mysqli_fetch_assoc($result_soil_and_set)) { ?>
								...
								<div id="menu1" class="tab-pane fade">
									<?php while ($data = mysqli_fetch_assoc($result_soil_and_set_details)) { ?>
										<div class="row">
											<div class="col-sm-12">
