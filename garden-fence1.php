...
if ($sort === 'price_low') {
	$query = "SELECT * FROM garden_fence ORDER BY price ASC";
} else if ($sort === 'price_high') {
	$query = "SELECT * FROM garden_fence  ORDER BY price DESC";
} else {
	$query = "SELECT * FROM garden_fence";
}

$result_garden_fence = mysqli_query($conn, $query);
$result_garden_fence_details = mysqli_query($conn, $query);
...
<body>
  ...
  <![endif]-->
									...
									<li><a href="#">Shop</a>
										<ul class="mega-menu">
											<li class="megamenu-single">
												...
												<ul>
													<li><a href="Garden-toys.html">Garden toys</a></li>
													<li><a href="Decorative-Pebbles.html">Decorative pebble</a></li>
													<li><a href="Garden-Brick.html">Garden bricks</a></li>
													<li><a href="Garden-fence.html">garden fence</a></li>
													<li><a href="garden Light.html">Garden outdoor Light</a></li>
											...
											<li class="megamenu-single">
												...
												<ul>
													<li><a href="Breakets.html">Breakets</a></li>
													<li><a href="batches.html"></a>Batches</li>
													<li><a href="Railing.html">Railing</a></li>
													<li><a href="Wheel-Barrows.html">Wheel Barrows</a></li>
													<li><a href="Spray-Bottles.html">Spray bottel</a></li>
												</ul>
											</li>
											...
											<li class="megamenu-single">
												...
												<ul>
													<li><a href="Soil-and-set.html">Soil-&-set</a></li>
	...
	<div class="page-banner-area bg-6 bannerback">
		<div class="container">
				...
				<div class="col-lg-3 col-md-4">
					<div class="sidebar sm-mt-0">
						...
						<div class="single-sidebar no-bg product-list">
							...
							<ul class="list-none">
								<li>
									<a href="#"><img src="assets/images/card/garden-toy-card-2.jpg" alt="" /></a>
							...
							<div class="tab-content mt-30">
								<div id="home" class="tab-pane active">
									<div class="row" id="products-list">
										<?php while ($data = mysqli_fetch_assoc($result_garden_fence)) { ?>
												...
												<div class="single-product">
													...
													<div class="product-thumb-sin">
														...
														<div class="product-action">
															<a href="" class="add-to-cart" data-name="<?php echo $data['Product']; ?>" data-price="<?php echo $data['price']; ?>" data-image="Plant Images/<?php echo $data['product_image']; ?>">
								...
								<div id="menu1" class="tab-pane fade">
									<?php while ($data = mysqli_fetch_assoc($result_garden_fence_details)) { ?>
										<div class="row">
											<div class="col-sm-12">
					...
					<div class="col-lg-3 col-sm-6">
						<div class="footer-widget style-2">
							...
							<div class="fooer-menu">
								...
								e33!2sAptech%20Defence%20Hyderabad!5e0!3m2!1sen!2s!4v1691651797021!5m2!1sen!2s" width="250" height="150" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6">
